...
\usepackage{graphicx} % поворот текста на 90 градусов
\usepackage{array} % типы столбцов

\usepackage{makecell} % объединение строк в одну клетку


\newcommand\monday{Понедельник}
\newcommand\tuesday{Вторник}
\newcommand\wednesday{Среда}
\newcommand\thursday{Четверг}
\newcommand\friday{Пятница}
\newcommand\saturday{Суббота}

\newcommand\oddWeek{Нечётная}
\newcommand\evenWeek{Чётная}

\newcommand\lessonNum[3]{\textbf{#1.} \\ #2 \\ #3}
\newcommand\firstLesson{\lessonNum{1}{9:00}{10:30}}
\newcommand\secondLesson{\lessonNum{2}{10:40}{12:10}}
\newcommand\thirdLesson{\lessonNum{3}{12:40}{14:10}}
\newcommand\fourthLesson{\lessonNum{4}{14:20}{15:50}}
\newcommand\fifthLesson{\lessonNum{5}{16:20}{17:50}}
\newcommand\sixthLesson{\lessonNum{6}{18:00}{19:30}}
\newcommand\seventhLesson{\lessonNum{7}{19:40}{21:00}}
...
\begin{tabular}{|c||*{6}{@{\hspace{.001\textwidth}}c@{\hspace{.001\textwidth}}|}}
    \hline
        ...
        % Четная неделя
        \rotatebox[origin=c]{90}{\evenWeek} &
